...
BEGIN
    ...
    UPDATE C##QLK.NHANSU SET DT = INP_DT WHERE MANV = INP_MANV;
    UPDATE C##QLK.NHANSU SET HOTEN = INP_HOTEN WHERE MANV = INP_MANV;
    
    UPDATE C##QLK.NHANSU SET PHAI = INP_PHAI WHERE MANV = INP_MANV;
    
    UPDATE C##QLK.NHANSU SET NGSINH = INP_NGSINH WHERE MANV = INP_MANV;
    
    UPDATE C##QLK.NHANSU SET PHUCAP = INP_PHUCAP WHERE MANV = INP_MANV;
