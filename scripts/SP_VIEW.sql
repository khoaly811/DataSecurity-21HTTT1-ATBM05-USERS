...
CREATE OR REPLACE PROCEDURE SP_VIEW_ADD_PHANCONG(
    ...
    QUERY_STRING VARCHAR2(1000);
BEGIN
    QUERY_STRING := 'SELECT HP.TENHP, KH.HK, KH.NAM, KH.NGAYBD, KH.MACT, HP.SOTC, HP.STLT, HP.STTH, HP.SOSVTD, DV.TENDV
...
END;
/
SELECT HP.TENHP, KH.HK, KH.NAM, KH.NGAYBD, KH.MACT, HP.SOTC, HP.STLT, HP.STTH, HP.SOSVTD, DV.TENDV
    FROM C##QLK.KHMO KH JOIN C##QLK.HOCPHAN HP ON HP.MAHP=KH.MAHP JOIN C##QLK.DONVI DV ON DV.MADV = HP.MADV;