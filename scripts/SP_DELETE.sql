...
CREATE OR REPLACE PROCEDURE SP_DELETE_DANGKY(
    ...
    INP_MAHP INT;
BEGIN
    SELECT MASV INTO INP_SV FROM C##QLK.SINHVIEN WHERE HOTEN = INP_TENSV;
    SELECT MANV INTO INP_MAGV FROM C##QLK.NHANSU WHERE HOTEN = INP_TENGV;
    SELECT MAHP INTO INP_MAHP FROM C##QLK.HOCPHAN WHERE TENHP = INP_TENHP;
