...
BEGIN
    ...
    ELSE
        ...
        IF USERROLE > 0 THEN
            PREDICATE := 'MAGV = ''' || USERNAME || ''' AND DANGKY.MAHP IN (SELECT KHMO.MAHP FROM KHMO WHERE DANGKY.HK = KHMO.HK AND DANGKY.NAM = KHMO.NAM AND SYSDATE < NGAYBD + 105 AND SYSDATE >= NGAYBD)';
        ELSE
            ...
            ELSE
                ...
                IF USERROLE > 0 THEN -- User is SV
                    PREDICATE := 'MASV = ''' || USERNAME || ''' AND DANGKY.MAHP IN (SELECT KHMO.MAHP FROM KHMO WHERE DANGKY.HK = KHMO.HK AND DANGKY.NAM = KHMO.NAM AND SYSDATE < NGAYBD + 15 AND SYSDATE >= NGAYBD - 5)';
                ELSE
...
SELECT * FROM KHMO;
insert into dangky values('SV0029', 'NV0185', 'HP0033', 3, 2023,'CLC', 8.4, 7.9, 9.1, 9);
insert into dangky values('SV0021', 'NV0185', 'HP0010', 3, 2023,'VP', 5, 6, 7, 8);
insert into dangky values('SV0008', 'NV0185', 'HP0010', 2, 2024,'VP', NULL, NULL, NULL, NULL);
commit;
