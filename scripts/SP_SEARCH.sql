...
CREATE OR REPLACE PROCEDURE SP_SEARCH_DANGKY(
    RESULT_CURSOR OUT SYS_REFCURSOR,
    INP_HOTEN VARCHAR2
)
AS
...
BEGIN
    SP_GRANT_EXECUTE('SP_SEARCH_DANGKY', 'TKHOA');
    SP_GRANT_EXECUTE('SP_SEARCH_DANGKY', 'TDV');
    SP_GRANT_EXECUTE('SP_SEARCH_DANGKY', 'GV');
    SP_GRANT_EXECUTE('SP_SEARCH_DANGKY', 'GVU');
    SP_GRANT_EXECUTE('SP_SEARCH_DANGKY', 'NVCB');
    SP_GRANT_EXECUTE('SP_SEARCH_DANGKY', 'SV');
END;
/