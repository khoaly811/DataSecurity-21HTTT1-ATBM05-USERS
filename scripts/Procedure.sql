...
BEGIN
    ...
    IF (TEMP_COUNT = 0) THEN
        RAISE_APPLICATION_ERROR(-20000,'THONG TIN KHONG TON TAI!');
    ELSE
        QUERY_STRING := 'SELECT HOTEN, TENHP, HK, NAM, MACT, MAHP, MAGV
...
BEGIN
    ...
    IF (TEMP_COUNT = 0) THEN
        RAISE_APPLICATION_ERROR(-20000,'THONG TIN KHONG TON TAI!');
    ELSE
        QUERY_STRING := 'SELECT SV.HOTEN AS HOTEN_SV, NS.HOTEN AS HOTEN_GV, HP.TENHP, HK, NAM, DK.MACT, DIEMTH, DIEMQT, DIEMCK, DIEMTK, MASV, MAGV
...
BEGIN
    ...
    ELSE
        ...
        QUERY_STRING := 'SELECT HOTEN, PHAI, NGSINH, PHUCAP, DT, VAITRO, TENDV, MANV 
                          ...
                          WHERE HOTEN LIKE :SEARCH_PATTERN';
        
        OPEN RESULT_CURSOR FOR QUERY_STRING USING SEARCH_PATTERN;
    END IF;
END;
/
